      ...
      <div className="grid grid-cols-1 gap-10 py-5.5 desktop:grid-cols-[1.05fr_1fr]">
        ...
        <div className="min-w-0">
          ...
          {product.freeDelivery !== "NONE" && (
            <div className="mt-3 inline-flex items-center gap-2 border border-lime/40 bg-lime/[0.08] px-3 py-1.5 text-[13px] text-lime">
              <TruckIcon className="h-4 w-4" />
              Free delivery — {product.freeDelivery === "INSIDE_DHAKA" ? "Inside Dhaka" : "Nationwide"}
            </div>
          )}
